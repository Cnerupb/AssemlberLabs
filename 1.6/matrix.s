.data
	filename:    .string "C:/Users/alexl/Assembler/AssemlberLabs/pr6/random_numbers.txt"  # ПУТЬ ФАЙЛА
	buffer:      .space 100           # буфер для чтения данных из файла
	matrix:      .word 100           # матрица (25 элементов по 4 байта)
...
parse_buffer:
        ...
        sw t6, 0(t4)              # сохраняем элемент в матрицу
